...
define('_TYPES_DEMO', [
	'site' => [
		'site_address' => [
			...
			'type' => 'text',
			'default' => '',
			'description' => 'Address for this site'
		],
		'site_contact' => [
			'label' => 'Site Contact',
			'linked' => FALSE,
			'type' => 'input',
			'default' => '',
			'description' => 'Name of site contact'
		],
		'site_phone' => [
			'label' => 'Site Telephone No',
			'linked' => FALSE,
			'type' => 'input',
			'default' => '',
			'description' => 'Telephone number for site'
		],
		'site_email' => [
			'label' => 'Site Email',
			'linked' => FALSE,
	...
	'company' => [
		...
		'company_phone' => [
			...
			'type' => 'input',
			'default' => '',
			'description' => 'Telephone number for this company'
		],
		'company_email' => [
			'label' => 'Email Address',
			'linked' => FALSE,
			'type' => 'input',
			'default' => '',
			'description' => 'Email address for this company'
		],
		'company_login' => [
			'label' => 'Login',
			'linked' => 'user',
			...
			'type' => 'select',
			'default' => '',
			'description' => 'Portal user login for this company'
		]
	],
	'contractor' => [
		'company_id' => [
			...
			'type' => 'select',
			'default' => '',
			'description' => 'The company this contractor works for'
		],
		'contractor_skill' => [
			...
			'default' => '',
			'description' => 'The type of work this contactor does'
		],
		'contractor_address' => [
			'label' => 'Address',
			'linked' => FALSE,
			'type' => 'text',
			'default' => '',
			'description' => 'Address for this contractor'
		],
		'contractor_phone' => [
			'label' => 'Telephone No',
			'linked' => FALSE,
			'type' => 'input',
			'default' => '',
			'description' => 'Telephone number for this contractor'
		],
		'contractor_email' => [
			'label' => 'Email Address',
			'linked' => FALSE,
			'type' => 'input',
			'default' => '',
			'description' => 'Email address for this contractor'
		],
		'contractor_dob' => [
			'label' => 'Date of Birth',
			'linked' => FALSE,
			'type' => 'date',
			'default' => 'now',
			'description' => 'Date of birth of this contractor'
		],
		'contractor_tandc' => [
			'label' => 'Agreed T&Cs',
			'linked' => FALSE,
			'type' => 'check',
			'default' => '',
			'description' => 'Has this contractor agreed to T&Cs?'
		],
		'contractor_hands' => [
			'label' => 'Viewed Safety Video',
			'linked' => FALSE,
			'type' => 'check',
			'default' => '',
			'description' => 'Has this contractor viewed the H&S video?'
		],
		'contractor_login' => [
			'label' => 'Login',
			'linked' => 'user',
			...
			'type' => 'select',
			'default' => '',
			'description' => 'Portal user login for this contractor'
		]
	],
	'certificate' => [
		'contractor_id' => [
			...
			'type' => 'select',
			'default' => '',
			'description' => 'The contractor this certificate is connected to'
		],
		'certificate_type' => [
			...
			'description' => 'The type of certificate this is'
		],
		'expiry_date' => [
			'label' => 'Expiry Date',
			'linked' => FALSE,
			'type' => 'date',
			'default' => 'now',
			'description' => 'The date this certificate is valid until'
		],
		'is_validated' => [
			'label' => 'Validated',
			'linked' => FALSE,
			'type' => 'check',
			'default' => 'no',
			'description' => 'Has this certificate been checked and verified?'
		],
		'media_file' => [
			'label' => 'Media File',
			'linked' => FALSE,
			'type' => 'file',
			'default' => '',
			'description' => 'Certificate media file'
		]
	],
	'document' => [
		'contractor_id' => [
			...
			'type' => 'select',
			'default' => '',
			'description' => 'The contractor this document is connected to'
		],
		'document_type' => [
			'label' => 'Document Type',
			'linked' => FALSE,
		...
		'media_file' => [
			...
			'type' => 'file',
			'default' => '',
			'description' => 'Document media file'
		]
	],
	'log' => [
		'user' => [
		...
		'date' => [
			...
			'type' => 'display',
			'default' => '',
			'description' => 'Date this action was performed'
		],
		'time' => [
			'label' => 'Time',
			'linked' => FALSE,
			'type' => 'display',
			'default' => '',
			'description' => 'Time this action was performed'
		],
		'action' => [
			'label' => 'Action',
			'linked' => FALSE,
